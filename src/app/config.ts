...
export const AI_SECRET_KEY = DEEPSEEK_API_KEY || OPENAI_SECRET_KEY;
export const AI_BASE_URL = DEEPSEEK_BASE_URL || OPENAI_BASE_URL;
export const AI_CONTENT_GENERATION_ENABLED = Boolean(AI_SECRET_KEY);
